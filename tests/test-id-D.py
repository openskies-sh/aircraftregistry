...
class CallPrivilegedOperatorPilot(TaskSet):
    ...
    def call_operator_detail(self):
        ...
        self.client.get("/api/v1/operators/41174c3f-e86c-4e5a-a629-32d4d9da6011", headers={})

    @task(2)
    def call_pilot_detail(self):
        authorization_header = "Bearer " + os.environ.get('API_TOKEN')
        self.client.get("/api/v1/aircrafts/0797d9ef-02d9-41cf-93ff-439aaf1609ae", headers={})
