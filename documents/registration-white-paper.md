...
| Entity ID | Entity Name | Entity Type | Notes |
|--- | --- | --- | --- |
|<b>A</b>| National Aviation Authority | National Agency | Per the EU regulation, the Member state must nominate a competent authority to build, maintain and operate a registry. We anticipate that in most cases it would be the National Aviation Authority |
|<b>B</b>| UTM Provider | Private Company | A company that provides software or Apps for RPAS flights might need to query the registry to get information. Some apps have capability to submit flight plans.   |
|<b>C</b>| Air Navigation Service Provider | Private Company / Public Private Entity | An ANSP is in charge of managing air-space above a designated territory, they will need to query and look at the registry to integrate that into their existing systems. |
|<b>D</b>| Law Enforcement (National / Local / International) | Public Entity | Law Enforcement might need to look at a registry to check the name, address, and other details of the operators. In many cases, it can be expected that the law enforcement maintains their own databases and might need privileged access to the data in real time. |
|<b>E</b>| Local public administration (e.g. Canton, local government) | Public Entity | In many cases a member state may have administrative units e.g. local governments, state governments that might need to query the national registry to check registration details. They may have specific requirements, laws that prohibit certain types of flights at a time and any operator breaking the rules might need to be queried, fined seamlessly.   |
|<b>F</b>| Cultural / Heritage Agencies | Public Entity | In some cases, RPAS flights over national or world heritage sites might be restricted. An agency that manages the cultural sites would be interested in querying the registry for operator or aircraft details.   |
|<b>G</b>| Environmental Agencies | Public Entity | Some environmental agencies might be interested in checking the operator registration details before approving or rejecting flights in their jurisdiction or in the event of a natural disaster: floods etc. |
|<b>H</b>| FAI - Fédération Aéronautique Internationale / World Air Sports Federation | Association | The FAI is an international association that manages airsports events and pilots for gliders, balloons, etc. in a case where there is an event, an affiliated club or national association organizing the event might need to check if the RPAS there are registered, licensed and insured. |
|<b>I</b>| Anti-RPAS companies / Private Security services | Private Companies | There are companies that specialize in taking down unauthorized RPAS or RPAS that invade private airspace. In some cases, a criminal or civil complaint may be necessary. In such a case they may need to check the registration data. |
|<b>J</b>| Organizations managing a specific area (e.g. ports, buildings) | Private Company / Public Private Entity | RPAS flights over certain areas need specific clearance or approvals and the authority managing those might need to verify the identity, training and other requirements from the registry |
|<b>K</b>| Cross border agencies | Public Agency | In some cases, RPAS would fly across international borders and law enforcement authorities from the neighboring jurisdiction might need to look at registration data |
|<b>L</b>| ICAO | International Organization | ICAO has an interest in RPAS and specifically a cross-border RPAS registration. They might require a unique ICAO number like for aircraft, in which case they would query the national database for registration information. |
|<b>M</b>| Private Citizens | Citizens | In some cases, citizens might need to query registration data if they see a RPAS on their land to return it to the operator, make a complaint, report a privacy violation etc. |
|<b>N</b>| Tax Authorities | Public Authorities | In cases where there is a tax, duty, or fee levied, tax authorities might need to check if the appropriate sum is paid for that equipment. |
|<b>O</b>| EASA / ANSP | Public Authorities | In some cases, to check the certificate of air worthiness needs to be checked and a registry could be a good place to store it. |
|<b>P</b>| Military | Military | When RPAS fly too close to military bases or are unauthorized, it might require further action from the military including counter terrorism operations. |
|<b>Q</b>| Insurance Companies | Private Company | As RPAS get more popular, insurance might become mandatory, the companies might need to communicate with the registry to provide their insurance number. In addition, the registry would be interesting for insurance companies as a marketing opportunity to identify operators who existing insurance is expiring |
|<b>R</b>| Marketing Companies | Private Company | For e.g. in jurisdictions with loose privacy regulations,   |
|<b>S</b>| RPAS and Equipment Retailers | Private Company | Both of these could be mandated or interested in submitting registration information and also might be interested in querying which operators have access to their particular RPAS or UA |
|<b>T</b>| RPAS Manufacturers | Private Company | In some jurisdictions the drone manufacturers might be obliged to send information about the drone including things like Cryptographic Public Key linked to the equipment to the registry. |
|<b>U</b>| Banks / Financial Institutions | Private Company / Public Private Entity | Property check for credit evaluation of drone pilots. Financing expensive equipment may require these institutions to have access to the data in the registry. |
|<b>V</b>| Statistical Office | Private Company / Public Private Entity | A statistical agency / entity may use the data, flight logs, flight declarations and build and present detailed stats out of data. |
|<b>W</b>| IT service providers | Private Company | Developing, managing, installing, maintaining, etc. the registry system or parts / components of it. |
